...
To play a game, you need to start the server first, then the clients.

Please note that [Java SE 20](https://www.oracle.com/java/technologies/javase/jdk20-archive-downloads.html) is required.
...
You can specify whether to use socket or RMI technology and a TUI instead of the GUI by providing arguments.
You can learn more by typing `java -jar /path/to/jarfile.jar -h`.
