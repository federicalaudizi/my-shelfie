 ...
 * @author Federico
 */
public class GameSupervisorString extends GameSupervisor<String>{
     ...
     */
    @Override
    public GameController<String> joinGame(String playerId, String gameId) {
     ...
     */
    @Override
    public GameController<String> joinGame(String playerId) throws NonExsistentGameException {
        return null;
    }
     ...
     */
    @Override
    public GameController<String> getGamebyId(String gameId) {
        return games.get(gameId);
    }
